...
{   
    ...
    public static final class SwerveDriveConstants
    {
        ...
        public static final double kMaxAngularSpeed = 36 * Math.PI; //Used to be 12 * PI
        ...
        public static final double kFrontLeftChassisAngularOffset = Math.PI / 4; // Angular offset of the module relative to the chassis in radians
        
        public static final int kFrontRightDrivingCanId = 4;
        public static final int kFrontRightTurningCanId = 5;
        public static final double kFrontRightChassisAngularOffset = (7 * Math.PI) / 4;
        ...
        public static final double kBackRightChassisAngularOffset = (5* Math.PI) / 4;
